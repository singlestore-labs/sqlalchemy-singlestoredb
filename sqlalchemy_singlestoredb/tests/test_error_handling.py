...
class TestErrorHandling(unittest.TestCase):
    ...
    def test_do_ping_connection_failure(self) -> None:
    ...
    def test_do_ping_cursor_execution_failure(self) -> None:
    ...
    def test_do_ping_fetchone_failure(self) -> None:
    ...
    def test_is_disconnect_with_errno_exceptions(self) -> None:
    ...
    def test_is_disconnect_with_message_patterns(self) -> None:
    ...
    def test_is_disconnect_normal_errors(self) -> None:
    ...
    def test_on_connect_exception_handling(self) -> None:
    ...
    def test_initialization_cloud_connection(self) -> None:
    ...
    def test_rollback_cloud_connection(self) -> None:
    ...
    def test_get_default_isolation_level_cloud(self) -> None:
    ...
    def test_get_default_isolation_level_normal_connection(self) -> None:
    ...
    def test_execute_context_no_execution_options(self) -> None:
